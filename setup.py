...
setuptools.setup(
    name="BeraChainToolsPro",
    version="1.1.3",
    author="yanjlee",
    author_email="yanjlee@163.com",
    description="BeraChainTools 一个为 BeraChain 生态系统设计的工具集，旨在帮助用户轻松地进行各种交互和操作。",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/BeraChainTools",  # 模块github地址
